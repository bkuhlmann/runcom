...
* 🔼 Updated all objects to be frozen by default - Brooke Kuhlmann
...
* 🔼 Updated to XDG 9.0.0 - Brooke Kuhlmann
* ⛔️ Removed custom error class - Brooke Kuhlmann
* 🔁 Refactored home spec to use Pathname change directory refinement - Brooke Kuhlmann
...
* 🔼 Updated to XDG 8.10.0 - Brooke Kuhlmann
